...
var buildTasks = ['scripts', 'html', 'sassy', 'images', 'fonts'];
...
gulp.task('watch:scripts', function() {
  watch(['src/js/**/*.js', '!src/js/lib/vendor/**/*.js'], function(files) {
     gulp.src(['src/js/**/*.js', '!src/js/lib/vendor/**/*.js'])
        .pipe(plumber({
...
gulp.task('watch:html', function() {
  watch(['src/**/*.html', '!src/js/lib/vendor/**/*.html'], function(files) {
    gulp.start('html');
  });
});
